...
<nav class="sticky top-0 z-30 bg-black text-white" aria-label="Primary">
	<div class="mx-auto flex max-w-[1540px] items-center justify-between gap-4 px-4 py-3 md:px-10 lg:px-16">
		...
		<div class="hidden items-center gap-6 text-[13px] font-medium md:flex">
